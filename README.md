# oss-audit-24BCE10467

This is my Open Source Software lab repo for auditing **Git** on **Ubuntu 24.04 (WSL2)**.

I’m **Niket** (`Niket`, reg no `24BCE10467`). I wrote a few small shell scripts to pull basic system info, check package info, audit a couple of directories, and scan a log file for keyword matches.
...
- `manifesto_Niket.txt` - Example output from the manifesto generator

## How to run the scripts

From the repo directory (`/home/Niket/oss-audit-24BCE10467`):
